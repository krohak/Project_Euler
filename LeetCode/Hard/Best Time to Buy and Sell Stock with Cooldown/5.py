...
def iterateTree(day, action, num_stock, profit, bought, prices):
    ...
    if (day, num_stock, profit, action) in memo:
        return memo[(day,num_stock,profit,action)]
    ...
    if day < len(prices):
        ...
        memo[(day, num_stock_updated, profit_updated, action)] = max_profit
        return max_profit
